// 연습8-6
// 선형 리스트 클래스 AryLinkedList<E>의 사용 예
...
class ArrayLinkedListTester {
	...
	enum Menu {
		...
		PURGE_NO(   "동일 번호의 노드를 삭제"),	//【연습8-4】
		PURGE_NAME( "동일 이름의 노드를 삭제"),	//【연습8-4】
		RETRIEVE(   "특정 노드를 출력"),			//【연습8-5】
		DUMP(       "모든 노드를 출력"),
		TERMINATE(  "종료");
	...
	public static void main(String[] args) {
		...
		do {
			switch (menu = SelectMenu()) {
			 ...
			 case PURGE_NO :							//【연습8-4】동일 번호의 노드를 삭제
					list.purge(Data.NO_ORDER);
					break;

			 case PURGE_NAME :						//【연습8-4】동일 이름의 노드를 삭제
					list.purge(Data.NAME_ORDER);
					break;

			 case RETRIEVE : {						//【연습8-5】특정 노드를 출력
